...
page('/subfora/:subforum_id', app.User.currentUserCheck, app.subforumView.init, app.Subforum.prototype.fetchThreads, app.Subforum.prototype.loadThreads, app.Subforum.prototype.render, app.Subforum.viewAndPostColors);
page('/subfora/:subforum_id/:subforum_title/threads/new', app.User.currentUserCheck, app.newThreadView.init);
