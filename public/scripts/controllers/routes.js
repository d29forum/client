...
page('/user/:username/edit', app.User.currentUserCheck, app.editUserView.init);
page('/user/:username', app.User.currentUserCheck, app.userView.init, app.User.prototype.fetch, app.User.loadCurrent, app.User.renderCurrent, app.User.renderCurrent);
